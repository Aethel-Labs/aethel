    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0A0A0A]">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-lg">Manage your todos and AI API keys</p>
        </div>
        ...
        <div className="card p-8">
          <div className="text-center space-y-6">
            <div>
              ...
              <p className="text-gray-400">Sign in with your Discord account to continue</p>
            </div>
        ...
        <div className="text-center">
          <p className="text-gray-400 text-sm">Need help? Contact us on our Discord server</p>
        </div>
      </div>
    </div>
  );
