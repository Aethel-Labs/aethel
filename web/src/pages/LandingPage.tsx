  ...
  return (
    <div className="min-h-screen p-8 relative">
      <a
        ...
        className="absolute top-4 right-4 p-3 bg-white hover:bg-gray-100 text-black rounded-full transition-all transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 shadow-lg hover:shadow-xl z-10"
      ...
      <footer className="mt-16 text-center text-gray-500 pb-8">
        ...
        <div className="mb-4">
          ...
          >
            <img src="/royale_logo.svg" alt="Royale Hosting" className="h-6 mx-auto filter" />
          </a>
        </div>
