        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-3 text-gray-600 dark:text-gray-300 mt-2">
              ...
              <li>
                You must comply with the terms of service of any third-party APIs you use with the
                Bot
              </li>
              <li>
          ...
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              The Bot is provided &quot;as is&quot; without any warranties. We are not responsible
              for any direct, indirect, incidental, or consequential damages resulting from the use
              of the Bot.
            </p>
          </section>
